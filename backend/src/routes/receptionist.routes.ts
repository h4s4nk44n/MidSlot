...
import {
  getPatients,
  getUsersForReceptionist,
  getUserDetailForReceptionist,
  getAssignedDoctors,
...
import {
  requestReceptionistProfileChange,
  verifyReceptionistProfileChange,
...
router.get("/users", getUsersForReceptionist);
router.get("/users/:id", getUserDetailForReceptionist);
router.post("/users/:id/profile-changes/request", requestReceptionistProfileChange);
router.post("/profile-changes/:requestId/verify", verifyReceptionistProfileChange);
